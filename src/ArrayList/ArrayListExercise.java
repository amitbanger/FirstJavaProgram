...
public class ArrayListExercise {
	public static void main(String[] args) {
		...
		//Print the list
		for (String elememt : list_StringsItr) {
		...
		list_StringsPosition.add("White");
		list_StringsPosition.add("Black");

		//Print the list
		System.out.println(list_StringsPosition);

		//Now insert color at the first and last position
		...
		System.out.println("List before sort: " +list_StringsSearch);
